          ...
          <div class="panel-body fb">
            <form method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" maxlength="255" placeholder="标题">
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" id="author" name="author" placeholder="作者" value="{{.uname}}">
                  </div>
                  <div class="col-sm-2">
                    <label for="views">浏览量</label>
                    <input type="text" class="form-control" id="views" name="views" placeholder="浏览量" value="5">
                  </div>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="info" name="info" placeholder="内容概要200字以内" style="height: 80px"></textarea>
              </div>
              <div class="form-group">
                <label for="content">内容</label>
                <textarea class="form-control" id="myEditor" style="height:500px;" name="content" placeholder="内容"></textarea>
              </div>
